...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/The_Anime_Saga'),
      InlineKeyboardButton('💬 Support', url='https://t.me/otakucentral2008')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/The_Anime_Saga')
    ]])
    if Config.START_PIC:
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/Universes_King')
                ]])
        )
    elif data == "caption":
        await query.message.edit_text(
